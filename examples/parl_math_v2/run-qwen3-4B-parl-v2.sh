...
# tool via miles' multi_turn.generate.
...
CKPT_ARGS=(
   ...
   --load ${REPO_DIR}/saves/Qwen3-4B-parl-v2/${RUN_ID}
   --save ${REPO_DIR}/saves/Qwen3-4B-parl-v2/${RUN_ID}
   --save-interval 50
)
...
WANDB_ARGS=(
   ...
   --wandb-group qwen3-4B-parl-v2-math
