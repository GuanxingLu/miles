...
# PARL smoke test on Qwen3-0.6B (math task).
...
CKPT_ARGS=(
   ...
   --load ${REPO_DIR}/saves/Qwen3-0.6B-parl/${RUN_ID}
   --save ${REPO_DIR}/saves/Qwen3-0.6B-parl/${RUN_ID}
   --save-interval 50
)
...
WANDB_ARGS=(
   ...
   --wandb-group qwen3-0.6B-parl-math
